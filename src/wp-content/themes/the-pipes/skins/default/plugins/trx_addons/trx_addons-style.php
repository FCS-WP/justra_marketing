...
if ( ! function_exists( 'the_pipes_trx_addons_get_css' ) ) {
	add_filter( 'the_pipes_filter_get_css', 'the_pipes_trx_addons_get_css', 10, 2 );
	function the_pipes_trx_addons_get_css( $css, $args ) {
