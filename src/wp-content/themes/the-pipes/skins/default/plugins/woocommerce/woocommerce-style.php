...
if ( ! function_exists( 'the_pipes_woocommerce_get_css' ) ) {
	add_filter( 'the_pipes_filter_get_css', 'the_pipes_woocommerce_get_css', 10, 2 );
	function the_pipes_woocommerce_get_css( $css, $args ) {
...
$fdir = the_pipes_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
