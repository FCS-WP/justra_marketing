...
Please install and activate it before starting to use the theme The Pipes .
...
Theme documentation is available on http://thepipes.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in The Pipes is Fontello.
